            ...
            def _creator():
                if question.llm == "openai":
                   ...
                   return ChatAnthropic(anthropic_api_key=REDACTED_SECRET,
                    ...
                    return ChatCohere(cohere_api_key=REDACTED_SECRET,
                                      model=question.model,
                                      temperature=question.temperature,
                                      max_tokens=question.max_tokens
                                      )
                    ...
                    return ChatGoogleGenerativeAI(google_api_key=REDACTED_SECRET,
                                                  model=question.model,
                                                  temperature=question.temperature,
                                                  max_tokens=question.max_tokens,
                                                  top_p=question.top_p,
                    ...
                    return ChatGroq(api_key=REDACTED_SECRET,
                                    model=question.model,
                                    temperature=question.temperature,
                                    max_tokens=question.max_tokens,
                                    top_p=question.top_p
                    ...
                    return ChatMistralAI(api_key=REDACTED_SECRET,
...
async def _create_standard_llm_instance(question) -> Any:
    ...
    try:
        if question.llm == "openai":
            ...
            return ChatCohere(
                cohere_api_key=REDACTED_SECRET,
                model=question.model,
                temperature=question.temperature,
                max_tokens=question.max_tokens
            )
